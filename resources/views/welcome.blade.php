            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $postsmikasa->name }}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $posts2b->name }}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach ($postscategory2b as $post2b)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{ $post2b->featured }}" alt="our case" class="cate-img">
                                    </div>
                                    <h6 class="case-item__title"><a href="{{ route('single.post', ['slug' => $post2b->slug ]) }}">{{ $post2b->title }}</a></h6>
                                </div>
                            </div>
                            @endforeach
